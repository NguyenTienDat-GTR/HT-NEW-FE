...
export const trainingRouteGroup: RouteGroup = {
    ...
    children: [
      route({
        ...
        actionPermissionPrefixes: ["training.requirement.create.", "training.requirement.update.", "training.requirement.delete.", "training.requirement.toggle."],
      ...
      route({
        ...
        actionPermissionPrefixes: ["training.course.create.", "training.course.update.", "training.course.delete.", "training.course.toggle."],
      ...
      route({
        ...
        actionPermissionPrefixes: ["training.score_component.create.", "training.score_component.update.", "training.score_component.delete.", "training.score_component.toggle."],
      ...
      route({
        ...
        actionPermissionPrefixes: ["training.score_formula.create.", "training.score_formula.update.", "training.score_formula.delete.", "training.score_formula.toggle."],
