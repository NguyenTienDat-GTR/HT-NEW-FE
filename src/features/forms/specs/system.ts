...
export const systemFormSpecs: ResourceFormSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "permissionCodes", label: "Danh sách quyền", type: "checkbox-list", required: true, optionsEndpoint: "/system/permissions", optionValue: "permissionCode", optionLabel: "permissionName", readOnlyOnEdit: true, section: "Chọn quyền" },
  ...
  },
  {
    ...
    fields: [
      { name: "username", label: "Tài khoản", type: "select", required: true, optionsEndpoint: "/system/accounts/permission-targets", optionValue: "username", optionLabel: "username", readOnlyOnEdit: true, section: "Liên kết" },
      { name: "effect", label: "Effect", type: "radio", required: true, options: effectOptions, section: "Hiệu lực" },
      { name: "permissionCodes", label: "Danh sách quyền", type: "checkbox-list", required: true, optionsEndpoint: "/system/permissions", optionValue: "permissionCode", optionLabel: "permissionName", readOnlyOnEdit: true, section: "Chọn quyền" },
