...
export const organizationRouteGroup: RouteGroup = {
    ...
    children: [
      route({
        ...
        actionPermissionPrefixes: ["organization.diocese.create.", "organization.diocese.update.", "organization.diocese.delete.", "organization.diocese.toggle."],
      ...
      route({
        ...
        actionPermissionPrefixes: ["organization.parish.create.", "organization.parish.update.", "organization.parish.delete.", "organization.parish.toggle."],
