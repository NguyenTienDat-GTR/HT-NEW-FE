...
export function ResourcePagination({
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-border px-4 py-3 text-sm text-muted xl:flex-row xl:items-center xl:justify-between">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
        ...
        <div className="flex flex-wrap gap-2" role="navigation" aria-label="Chọn trang">
          <Button disabled={isFirstPage} onClick={() => updatePage(0)} variant="outline">
            Đầu
          </Button>
          <Button disabled={isFirstPage} onClick={() => updatePage(page - 1)} variant="outline">
            Trước
          </Button>
          ...
          <Button disabled={isLastPage} onClick={() => updatePage(page + 1)} variant="outline">
            Sau
          </Button>
          <Button disabled={isLastPage} onClick={() => updatePage(totalPages - 1)} variant="outline">
            Cuối
          </Button>
        </div>
      </div>
