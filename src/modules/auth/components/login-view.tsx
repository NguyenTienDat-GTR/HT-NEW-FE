...
export function LoginView() {
  ...
  return (
    <main className="relative grid min-h-dvh overflow-hidden bg-app-canvas px-4 py-10">
      ...
      <section className="relative m-auto w-full max-w-155 rounded-[18px] border border-white/80 bg-white/88 p-8 shadow-[var(--shadow-elevated)] backdrop-blur-xl sm:p-10">
        <div className="mb-8 flex flex-col items-center text-center">
          <BrandMark className="justify-center" />
          <h1 className="mt-6 text-2xl font-semibold tracking-normal text-foreground">HT Management</h1>
        ...
        <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
          <label className="block text-sm font-semibold text-foreground">
            ...
            <span className="relative mt-2 block">
              ...
              <Input className="h-13 rounded-xl pl-12" autoComplete="username" placeholder="Nhập tên đăng nhập hoặc tài khoản" {...form.register("username")} />
            </span>
          ...
          <label className="block text-sm font-semibold text-foreground">
            ...
            <span className="relative mt-2 block">
              ...
              <Input className="h-13 rounded-xl pl-12 pr-12" type="password" autoComplete="current-password" placeholder="Nhập mật khẩu" {...form.register("password")} />
